ala kadu       complee updated code ivvu index js    const express = require('express');
...
app.use(express.static(path.join(\_\_dirname, 'build'))); // Serve React build files
...
res.sendFile(path.join(\_\_dirname, 'public', 'followups.html'));
});
