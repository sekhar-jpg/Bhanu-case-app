...
const Case = require('./models/Case'); // ✅ Add this to access Case model
const app = express();

// Middleware for parsing JSON
app.use(express.json());

// Serve static files from public folder (for followups.html, logo, etc.)
...
// Fetch all follow-ups (search support)
